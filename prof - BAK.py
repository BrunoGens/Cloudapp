...
langues = {
    'allemand': {'langue_apprentissage': 'de', 'langue_nom': 'allemand', 'code_langue': 'de-DE', 'google_language_code': 'de-DE', 'google_voice_name': 'de-DE-Wavenet-B'},
    'italien': {'langue_apprentissage': 'it', 'langue_nom': 'italien', 'code_langue': 'it-IT', 'google_language_code': 'it-IT', 'google_voice_name': 'it-IT-Wavenet-C'},
    'anglais': {'langue_apprentissage': 'en', 'langue_nom': 'anglais', 'code_langue': 'en-UK', 'google_language_code': 'en-GB', 'google_voice_name': 'en-GB-Wavenet-A'},
    'espagnol': {'langue_apprentissage': 'es', 'langue_nom': 'espagnol', 'code_langue': 'es-ES', 'google_language_code': 'es-ES', 'google_voice_name': 'es-ES-Wavenet-A'},
    'chinois': {'langue_apprentissage': 'zh', 'langue_nom': 'chinois', 'code_langue': 'zh-CN', 'google_language_code': 'cmn-CN', 'google_voice_name': 'cmn-CN-Wavenet-A'},
    'français': {'langue_apprentissage': 'fr', 'langue_nom': 'français', 'code_langue': 'fr-FR', 'google_language_code': 'fr-FR', 'google_voice_name': 'fr-FR-Wavenet-B'}
}
...
def recontact_users():
    ...
    for phone_number, user_data in memory.items():
        ...
        if days_since_last_interaction > 30:  # Par exemple, recontacter après 30 jours d'inactivité
            message = "Bonjour, comment vas-tu ? Comment se sont passés tes derniers jours ?"
